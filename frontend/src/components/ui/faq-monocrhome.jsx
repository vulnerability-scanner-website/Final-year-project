...
const faqs = [
  {
    question: "How does your AI-powered security testing work?",
    answer:
      "Our platform combines machine learning algorithms with traditional penetration testing techniques to identify vulnerabilities. We scan for SQL injection, XSS, CSRF, and other critical security flaws, providing detailed reports within hours.",
    meta: "Technology",
  },
  {
    question: "What types of applications can you test?",
    answer:
      "We test web applications, APIs, mobile backends, and cloud infrastructure. Our platform supports all major frameworks and technologies, adapting to your specific tech stack and security requirements.",
    meta: "Coverage",
  },
  {
    question: "How long does a security assessment take?",
    answer:
      "Initial automated scans complete within 24-48 hours. Comprehensive penetration testing with manual verification typically takes 5-7 business days, depending on application complexity and scope.",
    meta: "Timeline",
  },
  {
    question: "Do you provide remediation support?",
    answer:
      "Yes. Every vulnerability report includes detailed remediation guidance, code examples, and best practices. Our security experts are available for consultation to help your team implement fixes effectively.",
    meta: "Support",
  },
];
    ...
    <div
      ...
      <section
        ...
        <div
          ...
          <span className="faq1-intro__label">Security FAQ</span>
        ...
        <header
          ...
          <div className="space-y-4">
            ...
            <p className={`max-w-xl text-base ${palette.muted}`}>
              Everything you need to know about our AI-powered penetration testing platform and security services.
            </p>
          </div>
