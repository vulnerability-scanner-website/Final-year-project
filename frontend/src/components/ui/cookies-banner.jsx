    ...
    <div
      ...
      <div
          ...
          <svg
            ...
            <g fill="none" stroke="none">
              <g transform="scale(4,4)">
                ...
                <path
                  d="M23,34c-1.65,0 -3,1.35 -3,3c0,1.65 1.35,3 3,3c1.65,0 3,-1.35 3,-3c0,-1.65 -1.35,-3 -3,-3zM23,38c-0.55,0 -1,-0.45 -1,-1c0,-0.55 0.45,-1 1,-1c0.55,0 1,0.45 1,1c0,0.55 -0.45,1 -1,1z"
                  fill="#1a2c3d"></path>
                <path
                  d="M20,29c1.65,0 3,-1.35 3,-3c0,-1.65 -1.35,-3 -3,-3c-1.65,0 -3,1.35 -3,3c0,1.65 1.35,3 3,3zM20,25c0.55,0 1,0.45 1,1c0,0.55 -0.45,1 -1,1c-0.55,0 -1,-0.45 -1,-1c0,-0.55 0.45,-1 1,-1z"
                  fill="#1a2c3d"></path>
                <path
                  d="M18,43c-1.65,0 -3,1.35 -3,3c0,1.65 1.35,3 3,3c1.65,0 3,-1.35 3,-3c0,-1.65 -1.35,-3 -3,-3zM18,47c-0.55,0 -1,-0.45 -1,-1c0,-0.55 0.45,-1 1,-1c0,0.55 -0.45,1 -1,1z"
                  fill="#1a2c3d"></path>
              </g>
            </g>
          </svg>
        ...
        <div className="text-center mb-5">
          ...
          <p
            className="mt-2 text-sm sm:text-base leading-relaxed text-neutral-600 dark:text-neutral-300">
            Our site uses cookies to provide you with a smooth and personalized experience.
            By clicking “Accept”, you agree to our{" "}
            <a
              href={privacyHref}
              className="font-semibold underline text-orange-500 dark:text-orange-400 hover:text-orange-600 dark:hover:text-orange-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded-sm">
              Privacy Policy
            </a>.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <button
            type="button"
            className="relative inline-flex items-center justify-center px-4 py-2.5 sm:px-5 font-semibold text-white bg-orange-500 hover:bg-orange-600 active:bg-orange-700 rounded-3xl focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 transition-colors"
            onClick={handleAccept}>
            Accept
          </button>
          <button
            type="button"
            className="relative inline-flex items-center justify-center px-4 py-2.5 sm:px-5 font-semibold bg-neutral-200 text-neutral-800 hover:bg-neutral-300 active:bg-neutral-400 dark:bg-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-700 dark:active:bg-neutral-600 rounded-3xl focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500 transition-colors"
