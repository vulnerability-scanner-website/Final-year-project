...
const CreditCardForm = ({
    ...
    return (
      <div className="flex h-full w-full items-center justify-center bg-background p-4">
        <AnimatedTicket
          ...
          cardHolder={holder || "Liana80 Tudakova"}
          last4Digits={number.slice(-4) || "8237"}
  ...
  return (
    <main style={{ minHeight: "88vh", display: "grid", placeItems: "center" }}>
          ...
          <AlertDialogContent>
            ...
            <div className="space-y-3 my-4">
              <div className="flex justify-between">
                ...
                <span className="font-mono">**** **** **** {number.slice(-4)}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span>{month}/{year?.slice(-2)}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium">Amount:</span>
                <span className="font-semibold">$305.50</span>
              </div>
            </div>
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
              <AlertDialogAction onClick={handleConfirm}>Confirm Payment</AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
