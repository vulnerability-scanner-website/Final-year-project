        ...
        <Tabs defaultValue="active" className="space-y-6">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" side="bottom" className="bg-[#1a1a1a] border border-white/10 text-white">
                      <DropdownMenuItem className="hover:bg-yellow-500/10 hover:text-yellow-400 cursor-pointer" onClick={() => router.push(`/dashboard/developer/scan_management/${scan.id}`)}><Eye className="w-4 h-4" />View Details</DropdownMenuItem>
          ...
          <TabsContent value="vulnerabilities" className="space-y-4">
            <div className="text-sm text-white/40">
              ...
              <span className="ml-2 px-2 py-0.5 rounded-full text-xs font-semibold bg-red-500/10 text-red-400 border border-red-500/20">{vulnerabilities.length}</span>
            </div>
            {vulnerabilities.map((vuln) => (
              <div key={vuln.id} onClick={() => router.push(`/dashboard/developer/scan_management/${vuln.scanId}`)}
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-white/40 mt-1">Found in Scan #{vuln.scanId}</p>
                  </div>
